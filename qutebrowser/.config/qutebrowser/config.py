...
# {{{ Privacy redirect
redirects = {
    "youtube.com":"invidious.no-logs.com",
    "youtu.be":"invidious.no-logs.com",
    "twitter.com":"nitter.net",
    "reddit.com":"libreddit.no-logs.com"
}

redirkeys = list(redirects.keys())

def intercept(info: interceptor.Request):
    for i in range(len(redirects)):
        if redirkeys[i] in info.request_url.host():
            new_url = info.request_url
            new_url.setHost(redirects[redirkeys[i]])
            try:
